...
sequenceDiagram
    ...
    AggregateRoot->>EventStore: Store Domain Events
...
stateDiagram-v2
    [*] --> SagaStarted
    SagaStarted --> UserCreated : CreateUserCommand
    UserCreated --> KnowledgeBaseCreated : CreateKnowledgeBaseCommand
    KnowledgeBaseCreated --> NotificationSent : SendWelcomeNotificationCommand
    NotificationSent --> [*] : Success
    
    UserCreated --> UserCreationFailed : Compensation
    KnowledgeBaseCreated --> KnowledgeBaseCreationFailed : Compensation
    NotificationSent --> NotificationFailed : Compensation
    
    UserCreationFailed --> [*]
    KnowledgeBaseCreationFailed --> UserDeleted : DeleteUserCommand
    NotificationFailed --> KnowledgeBaseDeleted : DeleteKnowledgeBaseCommand
    
    UserDeleted --> [*]
    KnowledgeBaseDeleted --> UserDeleted
```
