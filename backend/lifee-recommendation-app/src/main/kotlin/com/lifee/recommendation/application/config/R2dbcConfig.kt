 ...
 */
@Configuration
@EnableR2dbcRepositories(basePackages = ["com.lifee.recommendation.infrastructure.persistence.repositories"])
@EnableTransactionManagement
class R2dbcConfig : AbstractR2dbcConfiguration() {
    
    @Value("\${spring.r2dbc.url:r2dbc:postgresql://localhost:5432/lifee_recommendation}")
