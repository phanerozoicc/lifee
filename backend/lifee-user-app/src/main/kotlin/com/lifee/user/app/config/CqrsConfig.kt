    ...
    private fun registerEventHandlers() {
        ...
        eventHandlers.values.forEach { handler ->
            ...
            if (genericTypes != null && genericTypes.isNotEmpty()) {
                ...
                eventBus(applicationContext.getBean(ObjectMapper::class.java)).registerHandler(eventType.kotlin as kotlin.reflect.KClass<Event>, handler as EventHandler<Event>)
